...
(setq monkeyc-keywords '("." ";" "?" ":" "class" "function" "return" "new" "var" "const" "module" "using" "as" "enum" "extends" "null" "native" "hidden" "static" "instanceof" "has" "if" "else" "do" "while" "for" "break" "continue" "switch" "default" "case" "try" "catch" "finally" "throw" "and" "or" "true" "false" "self" "private" "protected"))
